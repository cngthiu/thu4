...
public class Author extends TableImpl<AuthorRecord> {
    ...
    /**
     * The reference instance of <code>booksdb.AUTHOR</code>
     */
    ...
    /**
     * The column <code>booksdb.AUTHOR.AUTHOR_ID</code>.
     */
    ...
    /**
     * The column <code>booksdb.AUTHOR.NAME</code>.
     */
    public final TableField<AuthorRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>booksdb.AUTHOR.NATIONALITY</code>.
     */
    public final TableField<AuthorRecord, String> NATIONALITY = createField(DSL.name("NATIONALITY"), SQLDataType.VARCHAR(100), this, "");
    ...
    /**
     * Create an aliased <code>booksdb.AUTHOR</code> table reference
     */
    ...
    /**
     * Create a <code>booksdb.AUTHOR</code> table reference
     */
    public Author() {
    ...
    public List<UniqueKey<AuthorRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_AUTHOR_UK_AUTHOR_NAME);
    }
