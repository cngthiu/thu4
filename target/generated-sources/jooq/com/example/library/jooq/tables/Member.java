...
public class Member extends TableImpl<MemberRecord> {
    ...
    /**
     * The reference instance of <code>booksdb.MEMBER</code>
     */
    ...
    /**
     * The column <code>booksdb.MEMBER.MEMBER_ID</code>.
     */
    ...
    /**
     * The column <code>booksdb.MEMBER.FULL_NAME</code>.
     */
    public final TableField<MemberRecord, String> FULL_NAME = createField(DSL.name("FULL_NAME"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>booksdb.MEMBER.EMAIL</code>.
     */
    public final TableField<MemberRecord, String> EMAIL = createField(DSL.name("EMAIL"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>booksdb.MEMBER.PHONE</code>.
     */
    public final TableField<MemberRecord, String> PHONE = createField(DSL.name("PHONE"), SQLDataType.VARCHAR(30), this, "");

    /**
     * The column <code>booksdb.MEMBER.STATUS</code>.
     */
    public final TableField<MemberRecord, MemberStatus> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(9).nullable(false).defaultValue(DSL.inline("ACTIVE", SQLDataType.VARCHAR)).asEnumDataType(MemberStatus.class), this, "");
    ...
    /**
     * Create an aliased <code>booksdb.MEMBER</code> table reference
     */
    ...
    /**
     * Create a <code>booksdb.MEMBER</code> table reference
     */
    public Member() {
    ...
    public List<UniqueKey<MemberRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_MEMBER_UK_MEMBER_EMAIL);
    }
    ...
    public LoanPath loan() {
        if (_loan == null)
            _loan = new LoanPath(this, null, Keys.FK_LOAN_MEMBER.getInverseKey());
